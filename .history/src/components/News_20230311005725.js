...
const News = (props)=>{
    ...
    const updateNews = async ()=> {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=432c8b77277c4c3f902b88850c279f80&page=${page}&pageSize=12`; 
        setLoading(true)
        let data = await fetch(url);
    ...
    const fetchMoreData = async () => {   
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=import React from 'react'
...
export default NavBar&page=${page+1}&pageSize=12`;
        setPage(page+1) 
        let data = await fetch(url);
        let parsedData = await data.json()
